...
public class ChangeProtocolTest {
    ...
    @Test
    public void changeProtocol() throws InterruptedException {
        // Act
        connectionPage.menuButtonClick();
        menuPage.pressButton("Settings");
        settingsPage.changeProtocol();
        // Assert
        boolean expectedResult = true;
        Assert.assertEquals(expectedResult, settingsPage.isProtocolChanged());
    }
}